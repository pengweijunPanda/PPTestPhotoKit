...
@class HGAssetModel,HGProgressView,HGPhotoPreviewView;
@interface HGPhotoPreviewCell : HGAssetPreviewCell

@property (nonatomic, copy) void (^imageProgressUpdateBlock)(double progress);

@property (nonatomic, strong) HGPhotoPreviewView *previewView;
...
@interface HGVideoPreviewCell : HGAssetPreviewCell
